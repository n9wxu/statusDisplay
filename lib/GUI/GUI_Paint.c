...
parameter:
    ...
    Color_Background : Select the background color
******************************************************************************/
static int centerText(const char *text, int fontWidth, int centerlinePosition)
{
    int characterCount = strlen(text);
    int stringWidth = fontWidth * characterCount;
    return centerlinePosition - stringWidth / 2;
}

void Paint_DrawString_EN(UWORD Xstart, UWORD Ystart, const char *pString,
                         sFONT *Font, UWORD Color_Foreground, UWORD Color_Background, UWORD centered)
{
    UWORD Xpoint = Xstart;
    UWORD Ypoint = Ystart;
    ...
    if (centered)
    {
        Xpoint = centerText(pString, Font->Width, Xstart);
    }
                   ...
                   sFONT *Font, UWORD Digit, UWORD Color_Foreground, UWORD Color_Background)
{
    ...
    // show
    Paint_DrawString_EN(Xpoint, Ypoint, (const char *)Str, Font, Color_Foreground, Color_Background, 0);
}
